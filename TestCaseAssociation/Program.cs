...
namespace TestCaseAssociation
{
    class Program
    {
        ...
        private static bool AutomatedFieldsNeedToChange(string testName, string testCaseId)
        {
            ...
            if (workItem != null && workItem["fields"] != null && workItem["fields"]["Microsoft.VSTS.TCM.AutomatedTestName"] != null && workItem["fields"]["Microsoft.VSTS.TCM.AutomatedTestName"].ToString() == testName)
            {
                needToChange = false;
            }
            return needToChange;
